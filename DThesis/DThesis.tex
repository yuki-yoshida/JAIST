...
showing an example playbook, we will beliefly explain the YAML format.
%% =======================================================================
\begin{figure}
\small
\begin{verbatim}
...
service to be running. Similarly as a Chef recipe, tasks in a Ansible
...
of VMs. They provides domain specific languages to describe the
...
\noindent{\bf Step 1-4:} Split the current rule case into cases where
...
predicates. \\
Since every resource is {\tt initial} in an initial state,
\stt{init(S)} intuitively implies
