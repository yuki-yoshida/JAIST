...
proving to ensure the sufficient condition. Using the renaming and
composing plug-ins for the Rodin platform (a tool set for Event-B),
they defined a way of instantiating generic machines and generating
the sufficient condition as a theorem of the concrete machine whose
proof obligation will be ensured by Rodin's theorem prover.
Tikhonova, U., et al.~\cite{TikhonovaMBAV13} applied this idea to
verify LACE DSL programs for controlling lithography
machines. However, the generated theorems are too large for the
...
\item {\bf Template modules} enable to define general entities and to
  ...
  productivity.
\item {\bf Constructor-based inductive theorem prover} enables to
  easily follow the provided procedure and develop consistent
