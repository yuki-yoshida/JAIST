...
This thesis proposes a framework of interactive proof development for a
...
The major contributions of this thesis are that (1) it introduces the
...
This thesis proposes a ``framework'' of interactive proof development
...
The framework proposed in this thesis supports another approach, namely
...
One of the major contributions of this thesis is to introduce the idea
...
\end{itemize}
Although the above features of ​​this thesis are, in principle, not
...
%% ===============================================================
The second major contribution of this thesis is to show that the idea
...
architect also defines {\it operations}\footnote{In this thesis, we say
...
reason why named as ``template'' and in this thesis we simply say ``a
...
In this thesis, {\it behavior of topologies} means when
...
\stt{<~sv(1,open)~sv(2,open)~>}\footnote{{\tt *}, {\tt 1}, and {\tt +}
  ...
  search target.  Only \stt{=(*,1)=>+} is used in this thesis.}.  The
...
commands\footnote{As its name suggests, CITP has capability to
  ...
  we use it only for management of proof trees in this thesis.}:
\begin{itemize}
...
by a formal specification language, namely \cafeobj in this thesis.
...
{\tt myEIP::InsID})\footnote{In this thesis, we often use an identifier
...
the template. In this thesis, we use a very simple behavior model of
...
to hold. In the rest of this thesis, we mean ($p~\mbstt{leads-to}~q$)
...
\item We assume that types of capabilities and requirements are
  the same as relationships that link them in this thesis for the sake
  of simplicity.
\end{enumerate}
...
requirement in this thesis for the sake of simplicity. Thereby, an
...
behavior model of our TOSCA example in this thesis, there are four main
differences.

Firstly, they proved one specific protocol whereas this thesis proposes
...
In this thesis, we explain our framework using examples of system setup
...
the main contribution of this thesis, safety properties are of another
...
All of the \cafeobj codes of the framework and example proof scores in this thesis
